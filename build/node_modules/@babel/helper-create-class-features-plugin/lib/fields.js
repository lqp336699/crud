...
var _templateObject = _taggedTemplateLiteral(["\n          var ", " = ", "(\"", "\")\n        "], ["\n          var ", " = ", "(\"", "\")\n        "]),
    _templateObject2 = _taggedTemplateLiteral(["var ", " = new WeakMap();"], ["var ", " = new WeakMap();"]),
    _templateObject3 = _taggedTemplateLiteral(["var ", " = new WeakSet();"], ["var ", " = new WeakSet();"]),
    _templateObject4 = _taggedTemplateLiteral(["BASE(REF, PROP)[PROP]"], ["BASE(REF, PROP)[PROP]"]),
    _templateObject5 = _taggedTemplateLiteral(["\n    Object.defineProperty(", ", ", ", {\n      // configurable is false by default\n      // enumerable is false by default\n      writable: true,\n      value: ", "\n    });\n  "], ["\n    Object.defineProperty(", ", ", ", {\n      // configurable is false by default\n      // enumerable is false by default\n      writable: true,\n      value: ", "\n    });\n  "]),
    _templateObject6 = _taggedTemplateLiteral(["", ".set(", ", {\n    // configurable is always false for private elements\n    // enumerable is always false for private elements\n    writable: true,\n    value: ", ",\n  })"], ["", ".set(", ", {\n    // configurable is always false for private elements\n    // enumerable is always false for private elements\n    writable: true,\n    value: ", ",\n  })"]),
    _templateObject7 = _taggedTemplateLiteral(["\n      var ", " = {\n        // configurable is false by default\n        // enumerable is false by default\n        // writable is false by default\n        get: ", ",\n        set: ", "\n      }\n    "], ["\n      var ", " = {\n        // configurable is false by default\n        // enumerable is false by default\n        // writable is false by default\n        get: ", ",\n        set: ", "\n      }\n    "]),
    _templateObject8 = _taggedTemplateLiteral(["\n    var ", " = {\n      // configurable is false by default\n      // enumerable is false by default\n      writable: true,\n      value: ", "\n    };\n  "], ["\n    var ", " = {\n      // configurable is false by default\n      // enumerable is false by default\n      writable: true,\n      value: ", "\n    };\n  "]),
    _templateObject9 = _taggedTemplateLiteral(["\n        Object.defineProperty(", ", ", ", {\n          // configurable is false by default\n          // enumerable is false by default\n          // writable is false by default\n          value: ", "\n        });\n      "], ["\n        Object.defineProperty(", ", ", ", {\n          // configurable is false by default\n          // enumerable is false by default\n          // writable is false by default\n          value: ", "\n        });\n      "]),
    _templateObject10 = _taggedTemplateLiteral(["\n      Object.defineProperty(", ", ", ", {\n        // configurable is false by default\n        // enumerable is false by default\n        // writable is false by default\n        get: ", ",\n        set: ", "\n      });\n    "], ["\n      Object.defineProperty(", ", ", ", {\n        // configurable is false by default\n        // enumerable is false by default\n        // writable is false by default\n        get: ", ",\n        set: ", "\n      });\n    "]),
    _templateObject11 = _taggedTemplateLiteral(["\n      ", ".set(", ", {\n        get: ", ",\n        set: ", "\n      });\n    "], ["\n      ", ".set(", ", {\n        get: ", ",\n        set: ", "\n      });\n    "]),
    _templateObject12 = _taggedTemplateLiteral(["", ".add(", ")"], ["", ".add(", ")"]),
...
var privateNameHandlerLoose = {
  handle: function handle(member) {
    ...
    member.replaceWith(_core().template.expression(_templateObject4)({
...
function buildPrivateFieldInitLoose(ref, prop, privateNamesMap) {
  ...
  return _core().template.statement.ast(_templateObject5, ref, id, value);
}
...
function buildPrivateInstanceFieldInitSpec(ref, prop, privateNamesMap) {
  ...
  var value = prop.node.value || prop.scope.buildUndefinedNode();
  return _core().template.statement.ast(_templateObject6, id, ref, value);
}
...
function buildPrivateStaticFieldInitSpec(prop, privateNamesMap) {
  ...
  if (isAccessor) {
    ...
    return _core().template.statement.ast(_templateObject7, id.name, getId ? getId.name : prop.scope.buildUndefinedNode(), setId ? setId.name : prop.scope.buildUndefinedNode());
  }
...
function buildPrivateMethodInitLoose(ref, prop, privateNamesMap) {
  ...
  if (isAccessor) {
    ...
    return _core().template.statement.ast(_templateObject10, ref, id, getId ? getId.name : prop.scope.buildUndefinedNode(), setId ? setId.name : prop.scope.buildUndefinedNode());
  }
}
...
function buildPrivateInstanceMethodInitSpec(ref, prop, privateNamesMap) {
  ...
  if (isAccessor) {
    ...
    return _core().template.statement.ast(_templateObject11, id, ref, getId ? getId.name : prop.scope.buildUndefinedNode(), setId ? setId.name : prop.scope.buildUndefinedNode());
  }

  return _core().template.statement.ast(_templateObject12, id, ref);
}
...
function buildPrivateStaticMethodInitLoose(ref, prop, state, privateNamesMap) {
  ...
  if (isAccessor) {
    ...
    return _core().template.statement.ast(_templateObject13, ref, id, getId ? getId.name : prop.scope.buildUndefinedNode(), setId ? setId.name : prop.scope.buildUndefinedNode());
  }

  return _core().template.statement.ast(_templateObject14, ref, id, methodId.name);
}
