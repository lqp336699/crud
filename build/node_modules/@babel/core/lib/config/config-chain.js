...
function makeChainWalker(_ref6) {
  ...
  return function (input, context) {
    ...
    try {
      for (var _iterator = flattenedConfigs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var op = _step.value;
